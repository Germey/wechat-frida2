...
let hook_info = {
	...
	WxCount: 0x59779C0,
	// 昵称
	WxNickName: 0x5977B28,
	// 手机号
	WxPhoneNumber: 0x5977A68,
	// 登录设备
	WxDevice: 0x510,
}
...
function get_info(){
    ...
    let result = {
        // "wxid": wxid,
        "nick_name": ModAddress.add(hook_info.WxNickName).readUtf8String(),
        "number": ModAddress.add(hook_info.WxCount).readUtf8String(),
        "phone_number": ModAddress.add(hook_info.WxPhoneNumber).readUtf8String(),
